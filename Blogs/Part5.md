...
<details markdown="1">
  ...
  * Open this link in a new tab: [Part5.md on GitHub](https://github.com/abhigyan-pro/abhigyan-pro.github.io/blob/main/Blogs/Part5.md)
  ...
  * Click the **paperclip (📎)** or **plus (➕)** icon next to the text box to upload the file (or simply drag and drop `Part5.md` into the chat).
