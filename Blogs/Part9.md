...
<details markdown="1">
  ...
  * Open this link in a new tab: [Part9.md on GitHub](https://github.com/abhigyan-pro/abhigyan-pro.github.io/blob/main/Blogs/Part9.md)
  ...
  * Click the **paperclip (📎)** or **plus (➕)** icon next to the text box to upload the file (or simply drag and drop `Part9.md` into the chat).
  ...
  **To go deeper on a step before you run a command:**
  ...
  > I have attached the `Part9.md` file. Look at Step [X] and explain exactly what the command does and why we are doing it before I run it.
