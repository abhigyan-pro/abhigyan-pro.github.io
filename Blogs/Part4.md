...
<details markdown="1">
  ...
  * Open this link in a new tab: [Part4.md on GitHub](https://github.com/abhigyan-pro/abhigyan-pro.github.io/blob/main/Blogs/Part4.md)
  ...
  * Click the **paperclip (📎)** or **plus (➕)** icon next to the text box to upload the file (or simply drag and drop `Part4.md` into the chat).
  ...
  **To go deeper on a step before you run a command:**
  ...
  > I have attached the `Part4.md` file. Look at Step [X] and explain exactly what the command does and why we are doing it before I run it.
